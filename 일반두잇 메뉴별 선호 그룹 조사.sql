...
FROM (SELECT o.id         AS order_id,
            ...
            --  REGEXP_REPLACE(p.menu_name, '\\[[^\\]]*\\]', '') AS menu_name,
      ...
      FROM doeat_delivery_production.orders AS o
               ...
               JOIN doeat_delivery_production.menu AS p ON p.id = i.menu_id
